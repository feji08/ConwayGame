...
class GridTest {
    ...
    @Test
    void getCellNum() {
        assertEquals(0,this.testGrid.getCellNum("b"));
        this.testGrid.activateCell("b",10,10);
        assertEquals(1,this.testGrid.getCellNum("b"));
        this.testGrid.activateCell("a",9,10);
        assertEquals(1,this.testGrid.getCellNum("b"));
        this.testGrid.activateCell("b",47,10);
        assertEquals(2,this.testGrid.getCellNum("b"));
    }
}